  ...
  return (
    <div className="min-h-screen bg-surface text-on-surface">
      <div className="min-h-screen md:grid md:grid-cols-[260px_1fr]">
        ...
        <aside
          className={[
            "fixed inset-y-0 left-0 z-50 w-[280px] bg-surface-container-low p-4 transition-transform duration-300 md:hidden",
        ...
        <div className="min-w-0">
          {/* MOBILE */}
          <header className="sticky top-0 z-30 flex items-center justify-between bg-surface-container-low px-4 py-4 mb-6 md:hidden max-w-full">
            <div className="flex items-center gap-2 justify-center">
              ...
              <p className="text-primary-light text-2xl font-bold tracking-widest uppercase">
                Atlas
              </p>
            </div>
